...
function App() {
  const projects = [
    ...
    },
    {
      ...
      link: 'https://lotto.z-labs.kr', // Placeholder
      status: 'Coming Soon'
    },
    {
      id: 'lab',
      ...
      <header className="relative overflow-hidden bg-white border-b border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16 text-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-slate-500 max-w-2xl mx-auto mb-10">
              세상의 모든 재미를 실험합니다.<br/>
              <span className="text-base text-slate-400 mt-2 block">Experimental Fun Projects by Wooz</span>
            </p>
          </motion.div>
        </div>
      </header>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            <motion.a
              ...
              className={`group relative overflow-hidden rounded-2xl bg-white shadow-xl shadow-slate-200/50 border border-slate-100 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 block`}
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              <div className="p-8">
                ...
                <p className="text-slate-500 mb-6 min-h-[3rem]">
                  {project.desc}
                </p>
      ...
      <footer className="bg-white border-t border-slate-100 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-6 text-sm">
            <a href="https://balance.z-labs.kr/privacy" className="text-slate-500 hover:text-rose-500 transition-colors">
              Privacy Policy
            </a>
            <a href="mailto:contact@z-labs.kr" className="text-slate-500 hover:text-rose-500 transition-colors">
              Contact
            </a>
          </div>
        </div>
