      ...
      <section className="bg-white border-t border-slate-100 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-end mb-10">
            ...
            <Link href="/blog" className="text-rose-500 text-sm font-semibold hover:text-rose-600 flex items-center gap-1 transition-colors">
      ...
      <footer className="bg-white border-t border-slate-100 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-6 text-sm">
            <Link href="/privacy" className="text-slate-500 hover:text-rose-500 transition-colors">
              개인정보처리방침 (Privacy)
            </Link>
            <Link href="/terms" className="text-slate-500 hover:text-rose-500 transition-colors">
              이용약관 (Terms)
            </Link>
            <Link href="/inquiry" className="text-slate-500 hover:text-rose-500 transition-colors flex items-center gap-1">
