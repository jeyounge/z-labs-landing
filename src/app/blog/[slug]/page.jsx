    ...
    return (
      <div className="min-h-screen bg-slate-50 font-sans">
        ...
        <div className="pt-32 text-center">
          ...
          <Link href="/blog" className="text-rose-500 font-semibold hover:underline">← 블로그 목록으로</Link>
        </div>
      </div>
    );
  }
      ...
      <div className="pt-16">
        ...
        <header className="bg-white border-b border-slate-100 py-14">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
              <Link href="/blog" className="inline-flex items-center gap-1 text-slate-400 hover:text-rose-500 text-sm mb-6 transition-colors">
        ...
        <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-4">
            {prevPost && (
              <Link href={`/blog/${prevPost.slug}`} className="group flex items-start gap-3 p-5 bg-white rounded-2xl border border-slate-100 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all">
            ...
            {nextPost && (
              <Link href={`/blog/${nextPost.slug}`} className="group flex items-start gap-3 p-5 bg-white rounded-2xl border border-slate-100 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all md:col-start-2">
          ...
          <div className="mt-8 text-center">
            <Link href="/blog" className="inline-flex items-center gap-2 text-sm text-slate-500 hover:text-rose-500 font-medium transition-colors">
